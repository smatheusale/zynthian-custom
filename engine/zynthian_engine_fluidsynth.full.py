...
-o synth.reverb.active=0".format(self.jackname, self.jackname)
        ...
        # SF2 load + program select happens in set_preset; snapshot-restore must
        # re-fire set_preset after JACK is wired.
    ...
    def zynapi_get_formats(cls):
        return "sf2,sf3,zip,tgz,tar.gz,tar.bz2,tar.xz,7z,rar"
